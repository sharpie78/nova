...
# Print the current path to the virtual environment's site-packages
venv_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "venv", "lib", "python3.10", "site-packages"))

# Add the venv path to sys.path
...
class NovaTrayManager(QtWidgets.QSystemTrayIcon):
    def __init__(self, app):
        ...
        start_api_server(self.api_server_action, self.icons)
        ...
        try:
            ...
            logger.warning(f"Failed to check tray status: {e}")
